...
def main_GUI():
    ...
    def start(position):
        ...
        def answer_check():
             ...
             score_title=customtkinter.CTkLabel(root,text_color=text_colour,text=score_text,bg_color=bg_colour,fg_color=fg_colour, font=("ariel",50*avg_size), height=50*y_multi,width=180*x_multi)
             ...
             restart_button=customtkinter.CTkButton(root,text_color=text_colour,text=restart_text,bg_color=bg_colour,command=restart, font=("ariel",36*avg_size), height=60*y_multi,width=200*x_multi)
        ...
        if position < len(questions):
            ...
            question=customtkinter.CTkLabel(root,text_color=text_colour,text=questions[position],fg_color=fg_colour,wraplength=root.winfo_width()*0.5,font=("ariel",36*avg_size), height=150*y_multi,width=new_width*0.3)
            question.place(relx=0.5,rely=0.2,anchor='center')

            #next button for moving to next question
            next_button=customtkinter.CTkButton(root,text_color=text_colour,text=next_text,bg_color=bg_colour,state="disabled",command=lambda:start(position+1),font=("ariel",36*avg_size), height=50*y_multi,width=180*x_multi)
   ...
   #subprogram for settings menu
    def settings():
        ...
        translate_title=customtkinter.CTkLabel(root_settings,text_color=text_colour,text=translator_text,font=("ariel",18),fg_color=fg_colour, height=20,width=100)
